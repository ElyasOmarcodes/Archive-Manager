...
### PDF ته اکسپورټ — له مدغمې میټاډیټا سره
د ښودنې (پریویو) پاڼه کې **PDF** تڼۍ ده: ټوله پیښه — سرلیک،
درې‌ګونې نېټه، درجه، کیورډونه، شخصیتونه، ټول بلاکونه او د ضمیمو
جدول — په یوه A4 دوسیه کې راځي. لینکونه پکې کلیک‌کېدونکي وي.

ویډیو او غږ په PDF کې نه چلیږي، نو د هغو پرځای **کارت** رسمیږي:
نوم، ډول، حجم او نسبي مسیر — نو لوستونکی پوهیږي چې کوم شواهد شته
او چېرې دي.

**او میټاډیټا؟** یوازې نه رسمیږي — اصلي `metadata.json` (او
`content.json`) د PDF **ریښتینې ضمیمې** (`/EmbeddedFiles`) په بڼه
د فایل دننه ږدل کیږي. نو Acrobat یا هر معیاري لوستونکی یې د فایل
په توګه بېرته راکوي: له یوه PDF نه ټوله پیښه بیا جوړېدلی شي.
