...
### رسمي اکسپورټ — PDF یا ZIP
د ښودنې (پریویو) پاڼه کې **اکسپورټ** منو ده، دوه لارې لري:

| افشن | څه راځي |
|---|---|
| **یوازې PDF** | یوه دوسیه — د چاپ او لېږلو لپاره |
| **ZIP** | هماغه PDF + **اصلي** ویډیو، غږ او انځورونه |

PDF یو **رسمي سند** دی: د سند سرلیک‌کرښه، چوکاټ لرونکي جدولونه،
شمېرل شوې برخې (۱. لنډیز · ۲. متن · ۳. ضمیمې · ۴. میټاډیټا)، او
«مخ ۲ له ۳» پایښت. لینکونه پکې کلیک‌کېدونکي دي.

ویډیو او غږ په PDF کې نه چلیږي، نو د هغو پرځای یوه **جدولي کرښه**
راځي: ډول، نوم او نسبي مسیر — نو لوستونکی پوهیږي چې کوم شواهد شته
او چېرې دي.

**د پښتو تورو تړل.** د PDF کتابتون یوازې ۷۸ عربي توري پېژني —
د پښتو دا لس پکې نشته: **ټ ځ څ ډ ړ ږ ښ ګ ڼ ۍ**. نو کلمې یې
ماتولې: «چټک» → «چ ټ ک». اوس هر یو ته یو **پوروړی** توری ورکوو
چې کتابتون یې پېژني او د تړلو ډول یې هماغه دی، او فونټ د پوروړي
د بڼو پر ځای د پښتو ګلیفونه رسموي
(`tool/font/add_pashto_pdf_forms.py`). د PDF د `ToUnicode` جدول
بېرته سمیږي — نو له دوسیې کاپي شوی متن ریښتینی پښتو وي.

**او میټاډیټا؟ درې ځایه:**

۱. **XMP** (`/Metadata`) — د صنعت معیار (`dc:`, `xmp:`, او د
   آرشیف خپل `arvitch:` ډګرونه). Acrobat، Bridge او د آرشیف
   سیسټمونه یې پخپله لولي.
۲. **ضمیمه** (`/EmbeddedFiles`) — اصلي `metadata.json` او
   `content.json` د فایل دننه، نو له یوه PDF نه پیښه بیا جوړېدلی
   شي.
۳. **جدول** — د وروستۍ پاڼې پر مخ، نو انسان یې هم ولولي.

د ZIP بسته پاکه ده: یوازې PDF او ضمیمې — د پروګرام خپل ثبت
فایلونه پکې نه راځي، ځکه میټاډیټا پخپله د PDF دننه ده.
...
**حجم:** `ArchiveManager.exe` ~۱۴ MB (خام بسته ~۴۰ MB ده؛ د exe
دننه ZIP یې کموي). د `.xz` بسته‌بندي دلته ډېر لږ کموي (~۱٪) او
دا سم دی — محتوا لا دمخه کمپرس شوې ده، نو دوه‌ځلې کمپرس ګټه نه
لري. که بسته بې‌کمپرسه پرېښودل شوې وای، ډانلوډ به لږ څه کوچنی
و، خو کاروونکي ته به یو ۴۰ MB `exe` پاتې و — نو دا لار غوره ده.
