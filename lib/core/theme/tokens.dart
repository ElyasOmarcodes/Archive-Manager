...
class AppTokens {
  ...
  //
  // کاروونکي راپور کړه چې د لټون بار تر خپلو ګاونډیو تڼیو لوړ دی
  // او بد ښکاري. علت دا و چې هر ډول کنټرول خپل پیډنګ درلود، او
  // Material پخپله تڼیو ته د لمس لپاره ۴۸px لږ‌تر‌لږه لوړوالی
  // ورکاوه — خو فیلډونو ته یې نه ورکاوه.
  //
  // اوس ټول یو ټوکن ته اړوندیږي. که یو ځای بدل شي، هر ځای بدلیږي.
  static const double controlH = 38;

  /// لوی کنټرولونه — د اصلي عمل تڼۍ، د پاڼې سرلیک کې.
  static const double controlHLg = 44;
